      ...
      return (
        <main className="main report">
          <form onSubmit={(e) => this.handleSubmit(e)}>
              ...
              <input type="number" name="kmom" required min="1" max="10" onChange={(event) => this.handleChange(event)}></input>
              <label htmlFor="number">Kmom text:</label>
              <textarea name="text" required onChange={(event) => this.handleChange(event)}></textarea>
